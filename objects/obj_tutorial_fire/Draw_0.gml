...
draw_sprite_ext(sp_tut_pillars, 6, bbox_left, yy + h1, 1, 1, 0, c_white, water_alpha * alpha);
draw_sprite_ext(sp_tut_pillars, 7, bbox_right, yy + h2 - 4, 1, 1, 0, c_white, water_alpha * alpha);